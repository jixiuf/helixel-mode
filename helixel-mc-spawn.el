...
(declare-function helixel-treesit-sel-base "helixel-treesit-core" (sel) t)
(declare-function helixel-treesit-sel-part "helixel-treesit-core" (sel) t)
...
same (BASE . PART) type."
  (let* ((sel (or (and (boundp 'helixel--pending-sel)
                  ...
                  (and (boundp 'helixel-last-action)
                       helixel-last-action
                       (helixel-action-sel helixel-last-action))))
         (base (helixel-treesit-sel-base sel))
