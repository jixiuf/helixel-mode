...
FILES = helixel-debug.el helixel-core.el helixel-motion.el helixel-register.el helixel-ring.el helixel-macros.el helixel-repeat.el helixel-state.el helixel-move.el helixel-keymap.el helixel-search.el helixel-next-error.el helixel-editing.el helixel-surround.el helixel-swap.el helixel-textobj-engine.el helixel-textobj-pair.el helixel-textobj-block.el helixel-textobj-marks.el helixel-textobj.el helixel-mc-core.el helixel-mc-spawn.el helixel-shims.el helixel-treesit-core.el helixel-treesit-commands.el helixel-treesit.el helixel.el
ELS := helixel-debug.elc helixel-core.elc helixel-motion.elc helixel-register.elc helixel-ring.elc helixel-macros.elc helixel-repeat.elc helixel-state.elc helixel-move.elc helixel-keymap.elc helixel-search.elc helixel-next-error.elc helixel-editing.elc helixel-surround.elc helixel-swap.elc helixel-textobj-engine.elc helixel-textobj-pair.elc helixel-textobj-block.elc helixel-textobj-marks.elc helixel-textobj.elc helixel-mc-core.elc helixel-mc-spawn.elcc helixel-shims.elc helixel-treesit-core.elc helixel-treesit-commands.elc helixel-treesit.elc helixel.elc
