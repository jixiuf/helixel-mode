...
;;
;; Lives here (the lowest module in the repeat subsystem) so both
;; `helixel-repeat.el' and `helixel-search.el', plus the strategy
;; loops below, can consume it without circular requires.
