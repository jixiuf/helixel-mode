...
(ert-deftest helixel-test-action-category-mismatch ()
  ...
  (helixel-test-with-buffer "axb axb axb"
    ...
    (should (eq (helixel-action-category (car helixel--event-ring))
                'find-char))
    (let ((mark1 (marker-position
      ...
      (should (not (eq (marker-position
                       ...
                       mark1)))
      (should (= (length helixel--event-ring) 1))
      (should (eq (helixel-action-category (nth 0 helixel--event-ring))
                  'find-char)))))
...
(ert-deftest helixel-test-history-search-creates-proper-action ()
  ...
  (let ((helixel--event-ring nil) (helixel--live-action nil)
    ...
    (helixel-test-with-buffer "a test b"
      ...
      (should (= (length helixel--event-ring) 2))
      (should (eq (helixel-action-category (car helixel--event-ring)) 'search))
      (should (eq (helixel-action-subcat (car helixel--event-ring)) 'search))
      (should (car (helixel-action-mark-region (car helixel--event-ring)))))))
