...
;; Struct accessors generated by `cl-defstruct' (not visible to check-declare).
(declare-function helixel-find-char-sel-char "helixel-search" (sel) t)
(declare-function helixel-find-char-sel-type "helixel-search" (sel) t)
      ...
      (save-excursion
        (helixel-with-replay-as 'dot
          ...
          (let ((dummy (helixel-mc--make-dummy-action
                        ;; Reset n-count only on kinds that carry one
                        ;; (search / find-char); other structs lack the slot.
                        (if (helixel-sel-n-count sel)
...
motion or operator."
  (let* ((char (helixel-find-char-sel-char sel))
