...
(require 'helixel-repeat)           ; helixel-repeat-edit, chain replay
...
;; ----------------------------------------------------------------------
;;
;; Glue between the fake-cursor core and the repeat/chain subsystems:
;; per-cursor execution of `.`-repeat, chain broadcast, insert-key
;; broadcast, and the atomic-undo wrapping for dispatched commands.
